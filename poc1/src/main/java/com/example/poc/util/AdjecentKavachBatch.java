...
//      public int decodeMessageType14(byte[] data, int n, int startPosition,List<HeartBeatMessage> heartbeatBatch) throws JsonProcessingException {
//         int messageLength = CommonFile.byteArrayToInt(data, n, 2);
//         n += 2;
//         int messageSequence = CommonFile.byteArrayToInt(data, n, 2);
//         n += 2;
//         int stationaryKavachId = CommonFile.byteArrayToInt(data, n, 2);
//         n += 2;
//         int nmsSystemId = CommonFile.byteArrayToInt(data, n, 2);
//         n += 2;
//         int systemVersion = CommonFile.byteArrayToInt(data, n, 1);
//         n += 1;
//         String date = CommonFile.decodeDate(data, n);
//         n += 3;
//         String time = CommonFile.decodeTime(data, n);
//         n += 3;
//         String specificProtocol = CommonFile.bytesToHex(data, n, 1);
//         n += 1;
...
//         String messageType = CommonFile.bytesToHex(data, n, 2);
//         n += 2;
//         switch (messageType) {
//             // case "0101":
...
//             //     pdiVersionCheckPsk.setSenderIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//             //     n += 20;
//             //     pdiVersionCheckPsk.setReceiverIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//             //     n += 20;
//             //     pdiVersionCheckPsk.setPacketLength(CommonFile.byteArrayToInt(data, n, 2));
//             //     n += 2;
//             //     pdiVersionCheckPsk.setPdiVersion(CommonFile.byteArrayToInt(data, n, 1));
//             //     n += 1;
//             //     pdiVersionCheckPsk.setRp(CommonFile.byteArrayToInt(data, n, 2));
//             //     n += 2;
//             //     break;
//             // case "0102":
...
//             //     pdiVersionCheckSskToPsk.setSenderIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//             //     n += 20;
//             //     pdiVersionCheckSskToPsk.setReceiverIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//             //     n += 20;
//             //     pdiVersionCheckSskToPsk.setPacketLength(CommonFile.byteArrayToInt(data, n, 2));
//             //     n += 2;
//             //     pdiVersionCheckSskToPsk.setResultPdiVersionCheck(CommonFile.byteArrayToInt(data, n, 1));
//             //     n += 1;
//             //     pdiVersionCheckSskToPsk.setPdiVersionSsk(CommonFile.byteArrayToInt(data, n, 1));
//             //     n += 1;
//             //     pdiVersionCheckSskToPsk.setRN(CommonFile.byteArrayToInt(data, n, 2));
//             //     n += 1;
//             //     pdiVersionCheckSskToPsk.setMacCode(CommonFile.bytesToHex(data, n, 4));
//             //     n += 4;
//                 // break;
//             case "0103":
...
//                 heartBeatMessage.setPrimarySecondarySKavach(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 heartBeatMessage.setSecondarySecondarySKavach(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 heartBeatMessage.setPacketMessageLength(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 heartBeatMessage.setFrameNumber(CommonFile.byteArrayToInt(data, n, 3));
//                 n += 3;
//                 heartBeatMessage.setPacketMessageSequence(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 heartBeatMessage.setMacCode(CommonFile.bytesToHex(data, n, 4));
//                 n += 4;
//                 break;
//             // case "0104":
...
//             //     trainHandoverRequest.setSenderIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//             //     n += 20;
//             //     trainHandoverRequest.setReceiverIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//             //     n += 20;
//             //     trainHandoverRequest.setPacketMessageLength(CommonFile.byteArrayToInt(data, n, 2));
//             //     n += 2;
//             //     trainHandoverRequest.setFrameNumber(CommonFile.byteArrayToInt(data, n, 3));
//             //     n += 3;
//             //     trainHandoverRequest.setPacketMessageSequence(CommonFile.byteArrayToInt(data, n, 2));
//             //     n += 2;
//             //     trainHandoverRequest.setBorderRfidTag(CommonFile.byteArrayToInt(data, n, 2));
//             //     n += 2;
//             //     trainHandoverRequest.setInSections(CommonFile.bytesToHex(data, n, 1));
//             //     n += 1;
//             //     trainHandoverRequest.setDistToBorderTagLocation(CommonFile.byteArrayToInt(data, n, 2));
//             //     n += 2;
//             //     int m = n * 8;
...
//             //     m += 6;
//             //     n = m / 8;
//             //     trainHandoverRequest.setMacCode(CommonFile.bytesToHex(data, n, 4));
//             //     n += 4;
//             //     break;
//             // case "0105":
...
//             //     trainRRi.setSenderIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//             //     n += 20;
//             //     trainRRi.setReceiverIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//             //     n += 20;
//             //     trainRRi.setPacketMessageLength(CommonFile.byteArrayToInt(data, n, 2));
//             //     n += 2;
//             //     trainRRi.setFrameNumber(CommonFile.byteArrayToInt(data, n, 3));
//             //     n += 3;
//             //     trainRRi.setPacketMessageSequence(CommonFile.byteArrayToInt(data, n, 2));
//             //     n += 2;
//             //     trainRRi.setBorderRfidTag(CommonFile.byteArrayToInt(data, n, 2));
//             //     n += 2;
//             //     trainRRi.setRefProfileId(CommonFile.byteArrayToInt(data, n, 1));
//             //     n += 1;
//             //     trainRRi.setOnboardKavachIdentity(CommonFile.byteArrayToInt(data, n, 3));
//             //     n += 3;
//             //     m = n * 8;
...
//                 trainTakenOver.setSenderIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 trainTakenOver.setReceiverIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 trainTakenOver.setPacketMessageLength(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 trainTakenOver.setFrameNumber(CommonFile.byteArrayToInt(data, n, 3));
//                 n += 3;
//                 trainTakenOver.setPacketMessageSequence(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 trainTakenOver.setBorderRfidTag(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 trainTakenOver.setOnboardKavachIdentity(CommonFile.byteArrayToInt(data, n, 3));
//                 n += 3;
//                 trainTakenOver.setMacCode(CommonFile.bytesToHex(data, n, 4));
//                 n += 4;
//                 break;
//             case "0107":
...
//                 trainHandoverCancellation.setSenderIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 trainHandoverCancellation.setReceiverIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 trainHandoverCancellation.setPacketMessageLength(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 trainHandoverCancellation.setFrameNumber(CommonFile.byteArrayToInt(data, n, 3));
//                 n += 3;
//                 trainHandoverCancellation.setMessageSequence(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 trainHandoverCancellation.setBorderRfid(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 trainHandoverCancellation.setOnboardKavachIdentity(CommonFile.byteArrayToInt(data, n, 3));
//                 n += 3;
//                 trainHandoverCancellation.setMacCode(CommonFile.bytesToHex(data, n, 4));
//                 n += 4;
//                 break;
//             case "010A":
...
//                 tslRequest.setSenderIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 tslRequest.setReceiverIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 tslRequest.setPacketMessageLength(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 tslRequest.setFrameNumber(CommonFile.byteArrayToInt(data, n, 3));
//                 n += 3;
//                 tslRequest.setPacketMessageSequence(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 tslRequest.setBorderRfidTag(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 tslRequest.setOnboardKavachIdentity(CommonFile.byteArrayToInt(data, n, 3));
//                 n += 3;
//                 tslRequest.setTslRouteId(CommonFile.bytesToHex(data, n, 2));
//                 n += 2;
//                 tslRequest.setMacCode(CommonFile.bytesToHex(data, n, 4));
//                 n += 4;
//                 break;
//             case "010B":
...
//                 tslAuthority.setSenderIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 tslAuthority.setReceiverIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 tslAuthority.setPacketMessageLength(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 tslAuthority.setFrameNumber(CommonFile.byteArrayToInt(data, n, 3));
//                 n += 3;
//                 tslAuthority.setPacketMessageSequence(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 tslAuthority.setBorderRfidTag(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 tslAuthority.setOnboardKavachIdentity(CommonFile.byteArrayToInt(data, n, 3));
//                 n += 3;
//                 tslAuthority.setTslRouteRequestReply(CommonFile.bytesToHex(data, n, 1));
//                 n += 1;
//                 tslAuthority.setMacCode(CommonFile.bytesToHex(data, n, 4));
//                 n += 4;
//                 break;
//             case "010C":
...
//                 fieldElementsStatusRequest.setSenderIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 fieldElementsStatusRequest.setReceiverIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 fieldElementsStatusRequest.setPacketMessageLength(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 fieldElementsStatusRequest.setFrameNumber(CommonFile.byteArrayToInt(data, n, 3));
//                 n += 3;
//                 fieldElementsStatusRequest.setPacketMessageSequence(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 fieldElementsStatusRequest.setMacCode(CommonFile.bytesToHex(data, n, 4));
//                 n += 4;
//                 break;
//             case "010D":
...
//                 fieldElementsStatus.setSenderIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 fieldElementsStatus.setReceiverIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 fieldElementsStatus.setPacketMessageLength(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 fieldElementsStatus.setFrameNumber(CommonFile.byteArrayToInt(data, n, 3));
//                 n += 3;
//                 fieldElementsStatus.setPacketMessageSequence(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 int totalFieldElements = CommonFile.byteArrayToInt(data, n, 2);
...
//                 fieldElementsStatus.setMacCode(CommonFile.bytesToHex(data, n, 4));
//                 n += 4;
//                 break;
//             case "010E":
...
//                 trainHandoverCancellationAcknowledgement.setSenderIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 trainHandoverCancellationAcknowledgement.setReceiverIdentifier(CommonFile.byteArrayToInt(data, n, 20));
//                 n += 20;
//                 trainHandoverCancellationAcknowledgement.setPacketMessageLength(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 trainHandoverCancellationAcknowledgement.setFrameNumber(CommonFile.byteArrayToInt(data, n, 3));
//                 n += 3;
//                 trainHandoverCancellationAcknowledgement
//                         .setPacketMessageSequence(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 trainHandoverCancellationAcknowledgement.setBorderRfidTag(CommonFile.byteArrayToInt(data, n, 2));
//                 n += 2;
//                 trainHandoverCancellationAcknowledgement
//                         .setOnboardKavachIdentity(CommonFile.byteArrayToInt(data, n, 3));
//                 n += 3;
//                 trainHandoverCancellationAcknowledgement.setMacCode(CommonFile.bytesToHex(data, n, 4));
//                 n += 4;
//                 break;
//         }
//         String crc = CommonFile.bytesToHex(data, n, 4);
//         n += 4;
//         // if (pdiVersionCheckPsk != null) {
//         //     pdiVersionCheckPsk.setCrc(crc);
//         //     psktosskBatch.add(pdiVersionCheckPsk);
//         // }
//         // if (pdiVersionCheckSskToPsk != null) {
//         //     pdiVersionCheckSskToPsk.setCrc(crc);
//         //     sskToPskBatch.add(pdiVersionCheckSskToPsk);
//         // }
...
//             trainHandoverBatch.add(trainHandoverRequest);
//         }
...
//             tslAuthoritiyBatch.add(tslAuthority);
//         }
...
//             fieldElementsStatuBatch.add(fieldElementsStatus);
//         }
//         if (trainHandoverCancellationAcknowledgement != null) {
//             trainHandoverCancellationAcknowledgement.setCrc(crc);
//             cancellationAcknowledgementBatch.add(trainHandoverCancellationAcknowledgement);
//         }
//         return n;
//     }
